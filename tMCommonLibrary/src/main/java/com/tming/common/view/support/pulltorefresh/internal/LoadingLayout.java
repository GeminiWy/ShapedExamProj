...
import com.tming.common.view.support.pulltorefresh.ILoadingLayout;
...
public abstract class LoadingLayout extends FrameLayout implements ILoadingLayout {
    ...
    {
    	mHeaderImage.setBackgroundResource(R.drawable.arrow);
    }
    
    *//**
     * 设置下箭头
      * @Title: setDownArrowImage
      * @Description: TODO
      * @param 
      * @return void    返回类型
      * @throws
     *//*
    private void setDownArrowImage()
    {
    	mHeaderImage.setBackgroundResource(R.drawable.arrow_down);
    }*/
}
