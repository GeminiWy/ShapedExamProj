...
public final class Base64 {
	public static final String Base64Chars = "ABCDEFGHIJKLMNOP"
	 ...
	 * @return
	 */
	public static String encodeFoArray(final byte[] s) {
		if (s == null)
			return null;
		if (s.length == 0)
			return "";
	 ...
	 * @return
	 */
	public static byte[] decodeToArray(final String s) {
		if (s == null)
			return null;
