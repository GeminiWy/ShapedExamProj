 ...
 */
public class XKShortAnswerSubject extends XKSubject {
    ...
    public XKSubjectView createShowView(Context context) {
        return (XKSubjectView) View.inflate(context, R.layout.xk_doing_homework_subject_short_answer_view, null);
    }
}
