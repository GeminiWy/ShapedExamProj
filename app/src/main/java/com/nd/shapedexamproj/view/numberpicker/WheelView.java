...
package com.nd.shapedexamproj.view.numberpicker;
...
public class WheelView extends View {
	...
	private static final int VALUE_TEXT_COLOR = 0xFF00ff00;

	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = 0xFF000066;
	...
	private void initResourcesIfNecessary() {
		...
		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(R.drawable.transparent_item_bg);		//选中框背景
		}
		...
		setBackgroundResource(R.drawable.white);	//	没被选中框背景
	}
