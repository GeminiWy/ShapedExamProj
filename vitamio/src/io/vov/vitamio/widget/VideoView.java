...
public class VideoView extends SurfaceView implements MediaController.MediaPlayerControl {
  ...
  public void setVideoLayout(int layout, float aspectRatio) {
    ...
    Log.d("VideoView",String.format("VIDEO: %dx%dx%f, Surface: %dx%d, LP: %dx%d, Window: %dx%dx%f", mVideoWidth, mVideoHeight, mVideoAspectRatio, mSurfaceWidth, mSurfaceHeight, lp.width, lp.height, windowWidth, windowHeight, windowRatio) );
    mVideoLayout = layout;
  ...
  public boolean isPlaying() {
      boolean state = false ;
      try {
          state = isInPlaybackState() && mMediaPlayer.isPlaying();
      } catch (Exception e) {
          e.printStackTrace();
      }
      return state;
